...
logger = logging.getLogger("VisionExtractorService")
...
async def extract_findings(request: ImageRequest):
    try:
        ...
        # Extraer hallazgos (simplificado para demo)
        findings = {
            "finding": "Sin anomalías detectadas",
            "confidence": 0.92,
            "anomalies": [],
            "body_region": "tórax",
        ...
        if session is not None:
            try:
                # Resize and preprocess image for BiomedCLIP
